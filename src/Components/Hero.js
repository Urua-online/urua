  ...
  return (
    <section className='grid grid-cols-2 pt-4'>
      <div className='urua text-white rounded-br-3xl flex flex-col justify-center pt-16'>
          ...
          <div className='rounded-br-3xl bg-white text-black px-12 h-36 flex flex-col justify-center mt-4 mb-8'>
            <p className='text-lg font-semibold'>Our all-in-one shopping destination - Urua, designed to be your virtual supermarket, offering an unparalleled variety of items that cater to your every need and desire.</p>
          </div>
      ...
      <div className='flex relative justify-center'>
        ...
        <img src={spiral} alt="" className='absolute inset-28'/>
      </div>
    </section>
  )
}
