  ...
  return (
    <>
      <section className='' id='about'>
        ...
        {/* MISSION DIV  */}
        <div className='flex flex-col gap-4 md:grid grid-cols-2 items-center justify-center'>
        ...
        <div style={{ backgroundImage: `url(${spiral})` }} className='flex flex-col-reverse md:grid grid-cols-2 items-center'>
          <div className='flex justify-end relative'>
            <img src={bazuca} alt="" className='' />
            <img src={rectangle} alt="" className='absolute bottom-0 left-0 lg:w-80' />
          </div>
          ...
          <div className='flex flex-col px-8 py-16 text-center gap-4'>
            ...
            <div>
              <button className='bg-amber-400 text-white px-8 py-2 rounded-br-md w-full'>Start Shopping!</button>
            </div>
          </div>
        </div>

        {/* SELL BUY DELIVER DIV  */}
        <div className='px-4 lg:px-12 py-8 urua'>
          ...
          <div className='text-center my-8'>
            <button className='bg-amber-400 text-white px-8 py-2 rounded-br-md w-full md:w-1/2'>Get Urua</button>
          </div>
        </div>
      </section>
    </>
