...
export const FAQ = () => {
  return (
    <>
      <section className='px-12 py-8' id='FAQ'>
      ...
      <section className='py-8 grid grid-cols-2'>
        <div className='urua text-white rounded-br-3xl p-12 flex flex-col justify-center items-center h-80 relative'>
          <div>
        ...
        <div className='p-12 text-center border-b border-xl border-red-500'>
          ...
          <div className='flex items-center justify-center gap-4 my-8'>
            <div className='flex items-center justify-center gap-2 bg-slate-900 rounded text-slate-200 px-8 py-1'>
